      ...
      <main className="container mx-auto px-4">
        ...
        <section className="min-h-screen flex items-center justify-center">
          <div className="text-center w-full">
            ...
            <div className="mt-10 bg-white lg:max-w-4xl mx-auto px-6 py-8 rounded-xl shadow-sm">
              <h2 className="text-2xl font-bold mb-4">프로젝트 목적</h2>
            ...
            {/* 스크롤 유도 */}
            <div className="mt-12 text-gray-400 text-sm">↓ 스크롤하여 자세히 보기</div>
          </div>
        </section>
        ...
        <section
          ...
          className={`pb-16 transition-all duration-700 ease-out ${
            featureInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
        ...
        <section
          ref={stackRef}
          className={`pb-16 transition-all duration-700 ease-out delay-100 ${
